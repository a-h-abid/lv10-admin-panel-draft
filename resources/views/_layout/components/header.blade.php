...
<div class="flex items-center">
  ...
  @component('_layout/components/notifications-dropdown')
  @endcomponent

  @component('_layout/components/apps-dropdown')
  @endcomponent

  @component('_layout/components/language-dropdown')
  @endcomponent
  ...
  <div class="flex items-center ml-3">
    @component('_layout/components/user-dropdown')
    @endcomponent
  </div>
</div>
